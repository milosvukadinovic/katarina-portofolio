 ...
 const Quote = ()=>{
    return(
        <div class="body-quote" >
            <div class="pt-5" >
                <svg style={{height:"40px",with:"40px"}} xmlns="http://www.w3.org/2000/svg" viewBox="48.8 51 102.4 98.1" role="img">
    <g>
...
<div class="text-quote-italic">
<div class="text-qoute mt-5" > “Talent is a pursued interest. Anything that you're willing to practice, you can do.”</div></div>
<div class="text-qoute pt-4"> Bob Ross</div>
